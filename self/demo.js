...
$(function () {
    ...
    $.getJSON("http://172.16.9.60:10011/" + url + "?callback=?",
        function (data) {
//            $.cookie('wxqm', 'true');
//            $.cookie('timestamp', data.timestamp);
//            $.cookie('nonceStr', data.nonceStr);
//            $.cookie('signature', data.signature);
            wx.config({
                debug: false,
                appId: 'wx4fa3e82c8a2f0303',
